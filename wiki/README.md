...
╔══════════════════════════════════════════════════════════════════════════════╗
║                      POINTERS & REFERENCES IN GO                            ║
║──────────────────────────────────────────────────────────────────────────────║
║ 📌 Three key symbols:                                                       ║
║    - `*T`   → pointer to type T (used in types)                             ║
║    - `*x`   → dereference x (get value at address)                          ║
...
║                                                                              ║
║──────────────────────────────────────────────────────────────────────────────║
║ 📦 FUNCTION HEADERS EXAMPLES                                                 ║
║                                                                              ║
║   // PASS BY VALUE (copy, safe)                                              ║
║   func PrintArray(a NDArray)                                                 ║
║                                                                              ║
║   // PASS BY POINTER (modifies original)                                     ║
║   func (a *NDArray) Set(i int, v float64) error                              ║
║                                                                              ║
║   // DEREFERENCE a POINTER                                                   ║
║   func Deref(p *int) int { return *p }                                       ║
║                                                                              ║
║   // TAKE ADDRESS (from a value)                                             ║
║   func Ref() *int {                                                          ║
║       x := 10                                                                ║
║       return &x                                                              ║
║   }                                                                          ║
...
║──────────────────────────────────────────────────────────────────────────────║
║ 🧠 QUICK RULES                                                               ║
║   - Use `&` to get a pointer from a value                                    ║
║   - Use `*` to declare a pointer or dereference one                          ║
║   - Methods that modify the receiver → use `*Type` receiver                  ║
║   - If no mutation is needed, just pass by value                            ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
